...
- [x] Re-check Task 7 manually in root and fix bundled CLI eager TUI loading
...
- [x] Start PTY audit/polish Round 3: re-audit the first screen after detail compaction and rank the next highest-priority PTY findings
- [x] Fix the Round 3 PTY-audited high-priority TUI issue batch and add regression coverage
- [x] Run Round 3 verification and stop for `/compact`
...
- [x] Start PTY audit/polish Round 6: continue from the accepted Round 5 loading-feedback behavior and rank the next interaction/state-feedback issue batch
- [x] Fix the Round 6 PTY-audited high-priority TUI issue batch and add regression coverage
...
- [x] After `/compact`, start TUI CLI parity Task 3: modal UI, keyboard wiring, and doctor presentation
- [x] Create isolated worktree `.worktrees/tui-cli-parity-task3` for TUI CLI parity Task 3 and verify the targeted baseline
- [x] Implement TUI CLI parity Task 3: modal UI, keyboard wiring, and doctor presentation
- [x] Run TUI CLI parity Task 3 through spec review, spec-fix loops, code-quality review, quality-fix loops, and re-review
